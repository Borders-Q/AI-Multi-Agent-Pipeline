...
start_ps1 = """$Host.UI.RawUI.WindowTitle = "Ai Multi Agent 系统 - 一键启动"
...
stop_ps1 = """$Host.UI.RawUI.WindowTitle = "Ai Multi Agent 系统 - 一键关闭"
...
Get-NetTCPConnection -LocalPort 8000, 5173, 8001 -ErrorAction SilentlyContinue | Select-Object -ExpandProperty OwningProcess | Where-Object { $_ -ne 0 -and $_ -ne $PID } | ForEach-Object { Stop-Process -Id $_ -Force -ErrorAction SilentlyContinue }
...
restart_ps1 = """$Host.UI.RawUI.WindowTitle = "Ai Multi Agent 系统 - 一键重启"
$baseDir = $PSScriptRoot
...
with codecs.open('e:/比赛/Ai Multi Agent/_start.ps1', 'w', 'utf-8-sig') as f: f.write(start_ps1)
with codecs.open('e:/比赛/Ai Multi Agent/_stop.ps1', 'w', 'utf-8-sig') as f: f.write(stop_ps1)
with codecs.open('e:/比赛/Ai Multi Agent/_restart.ps1', 'w', 'utf-8-sig') as f: f.write(restart_ps1)
print("Done.")
