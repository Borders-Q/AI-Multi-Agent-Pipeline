...
start_ps1 = """$Host.UI.RawUI.WindowTitle = "天韬（SkyT） 系统 - 一键启动"
...
stop_ps1 = """$Host.UI.RawUI.WindowTitle = "天韬（SkyT） 系统 - 一键关闭"
...
restart_ps1 = """$Host.UI.RawUI.WindowTitle = "天韬（SkyT） 系统 - 一键重启"
$baseDir = $PSScriptRoot
...
with codecs.open('e:/比赛/AI Mu/_start.ps1', 'w', 'utf-8-sig') as f: f.write(start_ps1)
with codecs.open('e:/比赛/AI Mu/_stop.ps1', 'w', 'utf-8-sig') as f: f.write(stop_ps1)
with codecs.open('e:/比赛/AI Mu/_restart.ps1', 'w', 'utf-8-sig') as f: f.write(restart_ps1)
print("Done.")
