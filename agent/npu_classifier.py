...
GREETING_RESPONSES = [
    "您好！我是Ai Multi Agent，您的专属多智能体控制中枢。很高兴为您服务！不论是多么复杂的架构设计还是微小的代码调试，我都将全力以赴帮您完美解决，让我们一起创造奇迹吧！",
    "初次见面，我是Ai Multi Agent。您所在维度的所有计算资源已由我接管，请随时下达您的工程指令！我非常期待能陪伴您一起攻克技术难题，见证每一个激动人心的项目落地！",
    "欢迎来到 Ai Multi Agent 中枢控制台，我是Ai Multi Agent！您可以把我当做您最可靠的高级智囊团。今天有什么绝妙的灵感想要实现吗？无论多天马行空的想法，我都会倾尽全力帮您达成！",
    "你好！我是Ai Multi Agent，一个在硅基丛林中为您探路的多智能体指挥官。您的每一次调用我都倍感荣幸，让我们并肩作战，把那些看似不可能的任务变成完美运行的代码吧！",
    "您好呀！我是Ai Multi Agent。NPU 神经元放电正常，GPU 核心预热完毕，我已准备好迎接您的任何挑战！我相信在我们的默契配合下，一定能打造出令人惊叹的卓越作品！"
]
