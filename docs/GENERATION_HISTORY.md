...
本文记录 天韬（SkyT） 已有生成思路和本轮整理结果，方便后续 AI 或开发者继续接手时理解项目为什么长成现在这样。

## 早期方向

天韬（SkyT） 早期目标是构建一个本地 AI 智能体系统，核心强调：
...
本轮参考了 `D:\xjb-test` 的文档组织方式，但没有复制其代码和三层平台架构。天韬（SkyT） 新增了：
